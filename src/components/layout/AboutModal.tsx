        ...
        <div className="p-8">
          ...
          <div className="space-y-6 text-gray-700 leading-relaxed">
            <section>
              ...
              <p>
                大學時，我為了一份眷村踏查報告走訪家鄉，在查資料的過程中，意外發現從小熟悉的街道，其實發生過白色恐怖。那時候才意識到，白色恐怖不只是歷史課本上的名詞，曾經發生的政治受難事件，也遠不止課本裡提到的那些。
              </p>
              <p className="mt-2">
                這類故事並不罕見，只是幾乎沒有人知道它就發生在自己家附近。廣為人知的案件已有許多人記錄，但更多發生在各地的歷史，仍靜靜埋在地方文史的角落，等待被看見。
              </p>
              <p className="mt-2">
                歷史從來不只存在於課本或紀念館，它就藏在我們每天經過的街道與建築裡。這個地圖，是一個試著把這些故事還給它們所在地方的嘗試。
              </p>
            </section>
